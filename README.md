...
- **Release candidate:** `v2.2.0-beta.3` — draft-only exact protocol-profile opt-in for representative G4 Instant validation; no G4 audio validation or compatibility claim yet
