...
- **Prerelease:** immutable `v2.2.0-beta.3` is the current experimental camera-speaker release at merge SHA `76fca7f25a8f3b43e73ffd0432d97e5ec3995ce4`.
...
`v2.2.0-beta.2` at merge SHA `9d8e8f845201cf8de1223cc7d5fc31c192194a5d` and `v2.2.0-beta.3` at merge SHA `76fca7f25a8f3b43e73ffd0432d97e5ec3995ce4` were published manually after their exact-SHA candidate, trusted `main`, physical, and release-specific validation gates. No persistent version-specific publisher was introduced, so there is no publisher workflow to retire. Historical release scripts, release notes, and validation evidence remain version-controlled.
